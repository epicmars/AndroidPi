...
import com.androidpi.app.widget.TodoDateTimeView.Companion.TAG_DEADLINE
import com.androidpi.app.widget.TodoDateTimeView.Companion.TAG_START_TIME
...
@BindLayout(R.layout.activity_todo_edit)
@Injectable
class TodoEditActivity : BaseActivity<ActivityTodoEditBinding>(), TodoEditView, DatePickerFragment.OnDateSetListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.tvEditOptions?.setOnClickListener {
            val todoOptions = binding?.cTodoOptions
            ...
            binding?.tvEditOptions?.setCompoundDrawablesWithIntrinsicBounds(null, null, drawableRight, null)
        }
        ...
        // priority selection
        binding?.sbPriority?.max = 100
        binding?.sbPriority?.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
        ...
        mViewModel.mPriority.observe(this, object : Observer<Int> {
            ...
            override fun onChanged(t: Int?) {
                binding?.sbPriority?.setBackgroundColor(ColorModel.hsvToRgb(hsv.set(180 - ((t ?: 0) * 1.8f).toInt(), 0.89f, 1f), alpha = 255))
            }
        })
    }
